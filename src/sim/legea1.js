...
Events.on(render, 'afterRender', function () {
    ...
    // Description
    const topText = 'Inerția este proprietatea corpurilor de a se opune schimbării stării de repaus sau de mișcare rectilinie uniformă în care se aflau.';
    ...
    const topText2 = 'Inerția unui corp se manifestă doar când asupra lui acționează un alt corp, adică când corpul are o mișcare variată (accelerată/frânată).';
    ...
    const topText3 = 'Se poate aplica un impuls asupra corpurilor dând click pe ele.';
    context.font = '23.5px Arial';
